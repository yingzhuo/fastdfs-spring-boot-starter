...
public final class OtherConstants {
    ...
    public static final int FDFS_IP_ADDR_SIZE = 16;
    ...
    public static final String FDFS_RECORD_SEPARATOR = "\u0001";
    public static final String FDFS_FIELD_SEPARATOR = "\u0002";

    public static final int TRACKER_QUERY_STORAGE_FETCH_BODY_LEN = FDFS_GROUP_NAME_MAX_LEN + FDFS_IP_ADDR_SIZE - 1
            + FDFS_PROTO_PKG_LEN_SIZE;

    public static final int TRACKER_QUERY_STORAGE_STORE_BODY_LEN = FDFS_GROUP_NAME_MAX_LEN + FDFS_IP_ADDR_SIZE
            + FDFS_PROTO_PKG_LEN_SIZE;
